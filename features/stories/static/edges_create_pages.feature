Feature:  Create and view new individual edges through non-Ajax pages
  ...
  Scenario: Create new class-hierarchy-class edge
    ...
    And I select "itemFamily1 : itemFamily node number 1" from "Obj"
    When I press "Create"
  ...
  Scenario: Create new property-sub_property_of-property edge
    ...
    And I select "predecessor_of : Predecessor Of (wm built-in relationship)" from "Obj"
    When I press "Create"
    Then I should see "successfully created"
  ...
  Scenario: I can't create an item-contains-category edge
    ...
    And I select "contains : Contains (wm built-in relationship)" from "Relates to"
    And I select "myClass0 : myClass node number 0" from "Obj"
    When I press "Create"
    Then I should see "error"
  ...
  Scenario: I can't create an edge which would close a prohibited loop
    ...
    And I select "item0 : item node number 0" from "Obj"
    When I press "Create"
    Then I should see "error"
